...
class TUMDataset(Dataset):
    def __init__(self,
        ...
        self.mw = 32
        self.mh = 16
        self.intrinsic_crop = np.array([[fx, 0, cx - self.mw],
                                   [0, fy, cy - self.mh],
                                   [0, 0, 1]])
    ...
    def __getitem__(self, idx):
        ...
        image = cv2.undistort(image, self.intrinsic, self.d)
        ...
        image = image[self.mh:-self.mh, self.mw:-self.mw, :]
        depth = depth[self.mh:-self.mh, self.mw:-self.mw]

        sample = {"image": image, "depth": depth, "T": T, "intrinsics": self.intrinsic_crop}
